...
Entsprechend der zuvor angesprochenen Variationen im Verständnis von Mixed Reality gibt es in der Literatur Diskussionen darüber, wie die HoloLens zu klassifizieren ist. Microsoft selbst ordnet sie als MR Gerät ein. Peddie hingegen schreibt, dass ``manche argumentieren, die HoloLens sei ein AR Device, Microsoft jedoch, möglicherweise aus Gründen des Marketing und der besseren Produktabgrenzung, darauf besteht, sie sei als MR Device einzuordnen''. \cite{Peddie17}
