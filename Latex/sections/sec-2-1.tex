...
\begin{enumerate}
	...
	\item Steht in einem dreidimensionalem, räumlichen Zusammenhang
\end{enumerate}
...
%TODO SPatial Mapping Screenshot einfügen
...
Die technischen Eigenschaften der HoloLens haben Auswirkung auf Design und Nutzung von Anwendungen. Dazu gehören technisch bedingte Einschränkungen für Anwendungsszenarien, auf die hier kurz eingegangen werden soll.\\

\vspace{4px}
\textit{Einschränkungen durch das Tracking}\\
Damit das Tracking nicht behindert wird, gilt es vor allem folgendes zu vermeiden:
\begin{itemize}
	\item Große Mengen von stark spiegelnden oder transparenten Materialien in der Umgebung wie z.B. Glashaus
	\item Sehr große Räume, bei denen die Brille zu weit weg von einer Wand oder anderen Orientierungspunkten genutzt wird, z.B. Turnhalle
	\item Anwendung im Freien oder in einem Fahrzeug
	\item Quellen von Infrarot-Licht und Magnetfeldern
	\item Sehr stark oder sehr schlecht beleuchtete Räume
\end{itemize}

\vspace{4px}
\textit{Einschränkungen durch die Hardware}\\
Die Hardwareressourcen der HoloLens stellen eine weitere Limitierung für Anwendungen dar. Im Gegensatz zu aktuellen VR-Brillen (z.B. Oculus Rift, HTC Vice, PlayStation VR) nutzt die HoloLens keine externen, leistungsfähigen CPU- und Grafikeinheiten für die Bildberechnung. Dennoch sind zwei HD-Bilder mit 60 Hz auszugeben. Anwendungen sollten daher möglichst ressourcenschonend sein. Auf rechenintensive Operationen wie z.B. Schattenberechnungen oder Kantenglättung sollte meist verzichtet werden.\\

Dabei ist es von besonderer Bedeutung, dass die Anwendung möglichst konstant 60 Bilder pro Sekunde ausgibt. Um die Hologramme im Raum stabil und ohne Ruckler oder Zittern anzuzeigen, müssen selbst feinste Kopfbewegungen ausgeglichen werden. Dazu nutzt die HoloLens spezielle, KI basierte Verfahren.\\

Bevor eine Szene in die Render-Pipeline geht, trifft die Brille anhand der Sensordaten eine Vorhersage darüber, in welcher Position und Ausrichtung sich die Brille befinden wird, wenn das zu errechnende Bild dargestellt wird. Anhand dieser Schätzung wird die Kamera-Position und -Ausrichtung für die Szene festgelegt und anschließend gerendert.\\

Eine längere oder variierende Renderzeit bedeutet damit auch eine unzuverlässigere Schätzung. Das kann zu instabil wirkenden Darstellungen führen, z.B. in Form von Zittern oder Ruckeln. Deshalb empfiehlt Microsoft, die Framerate von 60 FPS stets aufrecht zu erhalten.