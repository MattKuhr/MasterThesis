	...
	\fbox{
		\parbox{0.9\linewidth}{
			...
			\begin{itemize}[rightmargin=12px, topsep=-12px]
				...
				\item Einstellungsmenu für IP, Feldstärke der Erde und weitere Parametern, Default-Werte vorhanden
				...
				\item Erklärungen per VO (optional)
