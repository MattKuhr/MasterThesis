...
Die technischen Eigenschaften der HoloLens haben Auswirkung auf Design und Nutzung von Anwendungen. Dazu gehören technisch sowohl bedingte Einschränkungen als auch zu berücksichtigende Aspekte für die Usability und Nutzererfahrung. Im Folgenden soll exemplarisch auf ausgewählte solcher Zusammenhänge hingewiesen werden.

\vspace{4px}
\textit{Einschränkungen durch das Tracking}\\
Ein wichtiger Punkt ist, das Tracking nicht zu behindern, da die Darstellungen andernfalls nicht korrekt im Raum positioniert werden können. Für die Stereo- und Tiefenkamera sind sehr dunkle und transparente Materialien problematisch, da hier kaum (Infrarot-) Licht reflektiert wird und so entsprechende Gegenstände nicht erkannt werden. Spiegelnde Materialien sind daher ebenfalls ungünstig. Darüber hinaus ist es wichtig, dass die Kamerasensoren genügend feste Ankerpunkte im Raum ausmachen können. Ungünstig sind daher z.B. zu viele sich bewegende Personen im unmittelbaren Umfeld der HoloLens.\\
